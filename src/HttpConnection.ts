...
import { AggregateErrors, DisabledTransportError, FailedToNegotiateWithServerError, FailedToStartTransportError, HttpError, AbortError } from "./Errors";
...
import { TaroWebSocketTransport } from "./TaroWebSocketTransport";
    ...
    private _constructTransport(transport: HttpTransportType): ITransport {
        switch (transport) {
            case HttpTransportType.WebSockets:
                return new TaroWebSocketTransport(this._httpClient, this._accessTokenFactory, this._logger, this._options.logMessageContent!);
            default:
